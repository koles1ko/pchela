<template>
	<div class="modal" v-if="modalOpen" @click="hideModal">
		<div class="modal__inner flex-body">
			<div class="modal__body" @click.stop="" v-if="!modalSend">
			...
			<div class="container">
				<div class="intro__content-inner">
					<div class="intro__text">
						Ремонт и обслуживание кондиционеров от
			...
			<div class="about__body flex-body">
				...
				<div class="about__description">
					<div class="about__text">
						<p>
							Сервисный центр «RemIce» предлагает весь спектр услуг <span
							class="text-bold">по ремонту и сервисному
							обслуживанию кондиционеров и систем вентиляции в Таганроге. </span>«RemIce» — это
							команда
